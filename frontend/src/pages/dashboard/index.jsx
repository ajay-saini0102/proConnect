            ...
            >
              ...
              >
                ...
                postState.comments.comments.length !== 0 && (
                  <div>
                    {postState.comments.comments.map((comment, idx)=>{
                    return(
                      <div className={styles.singleComment} key={comment._id}>
                        <img src={`${BASE_URL}/${comment.userId.profilePicture}`} alt="userProfilePicture" />
                        <div>
                        <div>
                ...
                {postState.comments.comments.length === 0 && <h2>No Comments</h2>}
